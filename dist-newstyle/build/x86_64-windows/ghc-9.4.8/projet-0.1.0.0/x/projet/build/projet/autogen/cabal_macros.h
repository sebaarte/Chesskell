...
/* package projet-0.1.0.0 */
#ifndef VERSION_projet
#define VERSION_projet "0.1.0.0"
#endif /* VERSION_projet */
#ifndef MIN_VERSION_projet
#define MIN_VERSION_projet(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projet */
...
#define CURRENT_COMPONENT_ID "projet-0.1.0.0-inplace-projet"
